...
AGENTIC_RUNNER_SCRIPT_CONTRACTS = {
    ...
    "scripts/tools/run_openclaw_agent_protocol.py": {
        ...
        "tokens": (
            ...
            ("NeMoClaw OpenClaw config default", "DEFAULT_NEMOCLAW_OPENCLAW_CONFIG_PATH"),
            ("NeMoClaw OpenClaw config resolver", "def effective_openclaw_config_path("),
            ("NeMoClaw OpenClaw config env pass-through", "OPENCLAW_CONFIG_PATH={config_path}"),
            ...
            ("explicit sandbox live session directory CLI", "--live-sandbox-session-dir"),
            ("explicit sandbox live session directory resolver", "def configured_live_sandbox_session_dirs("),
            ("NeMoClaw sandbox live session scanner", "def scan_nemoclaw_live_sessions("),
    ...
    "scripts/tools/run_agentic_math_openclaw.py": {
        ...
        "tokens": (
            ...
            ("OpenClaw config source resolver", "def openclaw_config_cache_source("),
            ("OpenClaw config source cache binding", '"openclaw_config_source": openclaw_config_cache_source(args)'),
            ...
            ("conversation-order cached result reuse guard", "def record_conversation_order_allows_reuse("),
            (
                "conversation-order cached result reuse call",
                "and record_conversation_order_allows_reuse(record)",
            ),
            ("tool-policy cached result reuse guard", "def record_tool_policy_allows_reuse("),
            ("tool-policy cached result reuse call", "and record_tool_policy_allows_reuse(record)"),
            ("Weave sidecar cached result reuse guard", "def record_weave_sidecar_allows_reuse("),
            (
                "Weave sidecar cached result reuse call",
                "and record_weave_sidecar_allows_reuse(record)",
            ),
            ("OpenClaw invocation cached result reuse guard", "def record_invocation_matches_cache("),
            (
                "OpenClaw invocation cached result reuse call",
            ...
            ("task-agent sandbox live session directory resolver", "def task_live_sandbox_session_dir("),
            ("task-agent sandbox live session directory handoff", "--live-sandbox-session-dir"),
    ...
    "scripts/tools/run_swebench_pro_openclaw.py": {
        ...
        "tokens": (
            ...
            ("conversation-order cached patch reuse guard", "def patch_record_conversation_order_allows_reuse("),
            (
                "conversation-order cached patch reuse call",
                "if not patch_record_conversation_order_allows_reuse(record):",
            ),
            ("tool-policy cached patch reuse guard", "def patch_record_tool_policy_allows_reuse("),
            ("tool-policy cached patch reuse call", "if not patch_record_tool_policy_allows_reuse(record):"),
            ("Weave sidecar cached patch reuse guard", "def patch_record_weave_sidecar_allows_reuse("),
            (
                "Weave sidecar cached patch reuse call",
                "if not patch_record_weave_sidecar_allows_reuse(record):",
            ),
            ("OpenClaw invocation cached patch reuse guard", "def patch_record_invocation_matches_cache("),
            (
                "OpenClaw invocation cached patch reuse call",
        ...
        if not matching_entries:
            ...
            for flag in WEAVE_AGENTS_SYNC_ENTRY_PROOF_FLAGS:
                if row.get(flag) is not True:
                    errors.append(f"{label} claimed entry {flag} must be true")
