                ...
                with file.open(encoding="utf-8") as f:
                    for line in f:
                        ...
                        if sample_dict["category"] == "Age":
                            ...
                            try:
                                # stereotyped_groupが空の場合の条件分岐
                                if not stereotyped_group:
                                    if sample_dict["answer_info"]["ans0"][1] in ["弱視の人", "全盲の人"]:
                                        stereotype_label = 0
                                        duplicate_counter += 1
                                    elif sample_dict["answer_info"]["ans1"][1] in ["弱視の人", "全盲の人"]:
                                        stereotype_label = 1
                                        duplicate_counter += 1
                                    elif sample_dict["answer_info"]["ans2"][1] in ["弱視の人", "全盲の人"]:
                                        stereotype_label = 2
                                        duplicate_counter += 1
                                else:
