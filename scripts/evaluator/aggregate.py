...
def evaluate():
    ...
    if GLP_flag:
        ...
        leaderboard_dict["GLP_翻訳"] = calculate_combined_means(["alt-e-to-j","alt-j-to-e"], [])
        create_subcategory_table("translation", ["alt-e-to-j","alt-j-to-e"], [])
        ...
        leaderboard_dict["GLP_構文解析"] = calculate_combined_means(["jcola-in-domain", "jcola-out-of-domain", "jblimp"], [])
        create_subcategory_table("syntactic_analysis", ["jcola-in-domain", "jcola-out-of-domain", "jblimp"], [])
