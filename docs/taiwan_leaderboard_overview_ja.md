...
最新の機械判定は `temp/taiwan_release_gate_20260701T083900Z.json` です。状態は `not_ready`、bundle整合性はOK、checked filesは631、verification errorsは0です。つまり「証跡bundleそのものは壊れていないが、本番公開条件はまだ満たしていない」という状態です。現在の残ブロッカーは `weave_content_canary`、`wandb_completion`、`paid_run_review_package`、`one_model_full_canary` の4つです。
...
latest gate: temp/taiwan_release_gate_20260701T083900Z.json
latest pointer: temp/latest_taiwan_release_gate.json
latest pointer verification: temp/latest_taiwan_release_gate_verify_20260701T083900Z.json
evidence bundle: outputs/taiwan_release_evidence/bundle_20260701T083900Z
release gate pointer proof: outputs/taiwan_release_evidence/bundle_20260701T083900Z/release_gate_pointer_proof.json
bundle integrity: OK
checked files: 631
...
最新の正式判定ファイルは、常に `temp/latest_taiwan_release_gate.json` から辿れます。2026-07-01 17:39 JST時点の実体は次です。

```text
release gate: temp/taiwan_release_gate_20260701T083900Z.json
latest pointer: temp/latest_taiwan_release_gate.json
latest pointer verification: temp/latest_taiwan_release_gate_verify_20260701T083900Z.json
operator plan: temp/taiwan_release_operator_plan_20260701T083900Z.md
evidence bundle: outputs/taiwan_release_evidence/bundle_20260701T083900Z
bundle verification: temp/taiwan_release_evidence_bundle_verify_20260701T083900Z.json
release gate pointer proof: outputs/taiwan_release_evidence/bundle_20260701T083900Z/release_gate_pointer_proof.json
status: not_ready
checked files: 631
verification errors: 0
...
3. temp/taiwan_release_operator_plan_20260701T083900Z.md
   次に人間が実行・承認すべき操作を見る。

4. outputs/taiwan_release_evidence/bundle_20260701T083900Z/summary.md
...
6. outputs/taiwan_release_evidence/bundle_20260701T083900Z/external_action_approval_packet.md
   有料API、W&B write、NeMoClaw install、scope confirmationの承認要件を見る。

7. outputs/taiwan_release_evidence/bundle_20260701T083900Z/operator_plan.md
...
11. temp/taiwan_existing_results_audit_20260701T083900Z.json
...
13. temp/taiwan_nemoclaw_adoption_check_20260701T083900Z.md
   NeMoClawがAgentic Math/SWE向けにadoptable_for_agentic_benchmarksであることを見る。
   temp/nemoclaw_setup_check_20260701T083900Z.json は runtime/sandbox状態の最新証跡を示す。
...
14. temp/nemoclaw_post_install_verification_20260701T083900Z.json
